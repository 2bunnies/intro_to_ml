# Part 4 - ML Zero to Hero
# Build an Image Classifier
https://www.youtube.com/watch?v=bemDFpNooA8&list=PLQY2H8rRoyvwWuPiWnuTDBHe7I0fMSsfO&index=4
...
```
part_4_build_an_iamge_classifier.ipynb
```

**3. Make sure you have access to below directory, and save it to your "My Drive/ML" directory:**
```
...
**6. Code: Setup: Import necessary libraries:**
```
# SETUP
# -----------------------------------------------------------------------------------
...
**15. Code: Visualize Training Result:**
```
...
**19. Code: Compile and Train Model:**
```
...
**20. Code: Visualize Train Results:**
```
# VISUALIZE TRAINING RESULTS
# -----------------------------------------------------------------------------------
